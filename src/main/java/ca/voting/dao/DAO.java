...
import ca.voting.beans.Address;
import ca.voting.beans.Vote;
import ca.voting.beans.Voter;
...
public class DAO {
	...
	public DAO()
	{
		...
		parties.add("Bharatiya Janata Party (BJP)");
		parties.add("Indian National Congress (INC)");
		parties.add("Aam Aadmi Party (AAP)");
		parties.add("Bahujan Samaj Party (BSP)");
		parties.add("Communist Party of India (CPI)");
	...
	// INITAL DATA LOAD METHODS
		...
		private String getRandomParty()
		{
			...
			switch (rand) {
			case 0:
				vote = "Communist Party of India (CPI)";
				break;
			case 1:
				vote = "Bahujan Samaj Party (BSP)";
				break;
			case 2:
				vote = "Aam Aadmi Party (AAP)";
				break;
			case 3:
				vote = "Bharatiya Janata Party (BJP)";
				break;
			case 4:
				vote = "Indian National Congress (INC)";
				break;
			}
